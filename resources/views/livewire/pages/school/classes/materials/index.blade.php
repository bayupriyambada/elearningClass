                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-actions btn-actions">
                                ...
                                <a href="{{ route('school.classes.materials.edit', [$classesId->id, $material->id]) }}" class="btn-action" title="ubah {{$material->title}}">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(0px, 38.6667px, 0px);" data-popper-placement="bottom-end">
                                  <a class="dropdown-item" href="#" wire:click="deleteData({{json_encode($material->id)}})">
