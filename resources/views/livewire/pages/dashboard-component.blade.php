                ...
                <div class="col-lg-6">
                    <div class="row row-cards">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <p class="mb-3">Using Storage <strong>{{$assignmentCount + $materialCount + $classesCount + $usersCount + $attendancesCount}} </strong>of 8 GB</p>
                                    <div class="progress progress-separated mb-3">
                                        <div class="progress-bar bg-primary" role="progressbar" style="width: {{$assignmentCount * ($assignmentCount / 100)}}%"
                                            aria-label="Assignment"></div>
                                        <div class="progress-bar bg-info" role="progressbar" style="width: {{$materialCount * ($materialCount/ 100)}}%"
                                    ...
                                    <div class="row">
                                        <div class="col-auto d-flex align-items-center pe-2">
                                            ...
                                            <span
                                                class="d-none d-md-inline d-lg-none d-xxl-inline ms-2 text-muted">{{$assignmentCount}}</span>
                                        </div>
